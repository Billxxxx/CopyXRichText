...
public class RichTextEditor extends ScrollView {
    public static final String tag = "XRichTextEditor";
        ...
        mTransitioner.addTransitionListener(new LayoutTransition.TransitionListener() {
            ...
            public void endTransition(LayoutTransition transition,
                ...
                if (!transition.isRunning()
                    ...
                    // mergeEditText();
                    if (imageHeight > 0) {
//                        scrollBy(0, imageHeight);

                        Message message = new Message();
                        message.arg1 = imageHeight;
                        message.what = 1;
    ...
    public EditText createEditText(String hint, int paddingTop) {
        ...
        editText.setHintTextColor(getContext().getResources().getColor(android.R.color.darker_gray));
        return editText;
    }
    ...
    public void insertImage(String imagePath) {
        insertImageByPath(imagePath);
    }

    public void insertImage(Object object) {
        insertImageByPath(object);
    }
     ...
     * 插入一张图片
     */
    public void insertImageByPath(Object imagePath) {
     ...
     * 在特定位置添加ImageView
     */
    public void addImageViewAtIndex(final int index, Object data) {
...
//        Glide.with(getContext()).load(imagePath).crossFade().centerCrop().into(imageView);
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        Log.d(tag, "onScrollChange l = " + l + " t = " + t + "");
    }
    ...
    public List<EditData> buildEditData() {
        ...
        for (int index = 0; index < num; index++) {
            ...
            if (itemView instanceof EditText) {
                ...
                itemData.imagePath = item.getData();
            }
